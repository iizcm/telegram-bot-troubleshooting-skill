...
[![Category: Hermes](https://img.shields.io/badge/Category-Hermes-purple)](#)

| Field | Value |
| --- | --- |
| **Name** | `telegram-bot-troubleshooting-skill` |
...
cp -r hermes/telegram-bot-troubleshooting ~/.hermes/skills/hermes/telegram-bot-troubleshooting/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/telegram-bot-troubleshooting-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/telegram-bot-troubleshooting-skill.git ~/.hermes/skills/hermes/telegram-bot-troubleshooting/
```
...
```text
skill_view(name="hermes/telegram-bot-troubleshooting")
```
...
```text
Use the telegram bot troubleshooting skill to <describe your specific task here>
```
...
```text
Gunakan skill telegram bot troubleshooting untuk <deskripsikan tugas spesifik Anda di sini>
```
